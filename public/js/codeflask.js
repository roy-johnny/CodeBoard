!function (e, t) {
        ...
        var t = function (e) {
            var t = /\blang(?:uage)?-([\w-]+)\b/i, n = 0, a = {
                ...
                highlightElement: function (n, s, i) {
                    ...
                    var c = {element: n, language: r, grammar: o, code: n.textContent}, u = function (e) {
                    ...
                    } else u(a.highlight(c.code, c.grammar, c.language)); else u(a.util.encode(c.code)); else a.hooks.run("complete", c)
                },
                ...
                matchGrammar: function (e, t, n, i, r, o, l) {
                    for (var c in n) if (n.hasOwnProperty(c) && n[c]) {
                        ...
                        for (var d = 0; d < u.length; ++d) {
                            var p = u[d], h = p.inside, g = !!p.lookbehind, f = !!p.greedy, b = 0, m = p.alias;
                            ...
                            for (var k = i, x = r; k < t.length; x += t[k].length, ++k) {
                                ...
                                if (!(v instanceof s)) {
                                    ...
                                    if (S) {
                                        ...
                                        var L = v.slice(0, w), E = v.slice(F), N = [k, _];
            ...
            if (e.Prism = a, s.stringify = function (e, t, n) {
                ...
                var n = JSON.parse(t.data), s = n.language, i = n.code, r = n.immediateClose;
    ...
    return d.prototype.startEditor = function () {
        ...
        if (this.opts.handleTabs) {
            ...
            e.preventDefault();
            var t = this.elTextarea, n = t.selectionDirection, a = t.selectionStart, s = t.selectionEnd, i = t.value,
                r = i.substr(0, a), o = i.substring(a, s), l = i.substring(s), c = " ".repeat(this.opts.tabSize);
            if (a !== s && o.length >= c.length) {
                var u = a - r.split("\n").pop().length, d = c.length, p = c.length;
        ...
        if (this.opts.handleNewLineIndentation && 13 === e.keyCode) {
            e.preventDefault();
            var t = this.elTextarea, n = t.selectionStart, a = t.selectionEnd, s = t.value, i = s.substr(0, n),
                r = s.substring(a), o = s.lastIndexOf("\n", n - 1), l = o + s.slice(o + 1).search(/[^ ]|$/),
                c = l > o ? l - o : 0, u = i + "\n" + " ".repeat(c) + r;
        ...
        if (this.skipCloseChar(e)) {
            var a = this.code.substr(n, 1) === e, s = a ? n + 1 : n, i = !a && ["'", '"'].includes(e) ? e : "",
            ...
            var l = this.code.substring(t, n), c = "" + this.code.substring(0, t) + l + o + this.code.substring(n);
            this.updateCode(c)
        }
